            ...
            <div id='triangles-container'>
              <div id='triangles'>
                <img
                  ...
                  id='circle-triangle'
                  src='assets/images/triangles/circle-triangle.svg'
                  alt=''
                />
                <div
                  id='left-orange-container'
                  className='container grow animated infinite pulse duration-5s delay-4s'>
                  <img
                    className='animated zoomIn image'
                    id='left-orange'
                    src='assets/images/triangles/left-orange.svg'
                    alt=''
                  />
                ...
                <img
                  className='animated zoomIn'
                  id='blue-outline'
                  src='assets/images/triangles/blue-outline.svg'
                  alt=''
                />
                <img
                  className='animated zoomIn'
                  id='left-black-outline'
                  src='assets/images/triangles/left-black-outline.svg'
                  alt=''
                />

                <div id='yellow-triangle-container' className='container grow'>
                  <img
                    className='animated zoomIn image'
                ...
                <img
                  className='animated zoomIn'
                  id='orange-outline'
                  src='assets/images/triangles/orange-outline.svg'
                  alt=''
                />
                <img
                  className='animated zoomIn'
                  id='blue-triangle'
                  src='assets/images/triangles/blue.svg'
                  alt=''
                />
                ...
                <img
                  ...
                  src='assets/images/triangles/right-black-outline.svg'
                  alt=''
                />
              </div>
            </div>
